...
export class FormPaymentComponent implements OnInit {
  // Public
  public creditCardPaymentInfo: FormGroup;
   ...
   */
  get paymentForm() {
    return this.creditCardPaymentInfo.controls;
  }
  ...
  onSubmit(creditcardForm) {
    ...
    if (this.creditCardPaymentInfo.invalid) {
      return;
    }
    // updated Credit Card Info and Call POST request internally
    this._formPaymentService.setCreditCardInfo(creditcardForm.value);
  }
  ...
  ngOnInit(): void {
    this.creditCardPaymentInfo = this.formBuilder.group({
